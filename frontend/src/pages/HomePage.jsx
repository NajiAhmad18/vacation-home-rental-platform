...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pb-20">
      ...
      <div 
        className="relative bg-cover bg-center py-28 px-4 sm:px-6 lg:px-8"
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto text-center z-10">
          <span className="inline-flex items-center space-x-1.5 bg-white/10 backdrop-blur-md text-blue-300 text-xs font-semibold px-3.5 py-1.5 rounded-full mb-6 border border-white/10">
            <Compass className="w-3.5 h-3.5 animate-spin-slow text-blue-400" />
            <span>Discover Verified Luxury Stays</span>
          </span>
          ...
          <p className="max-w-2xl mx-auto mt-6 text-base sm:text-lg text-gray-200 leading-relaxed">
          ...
          <form
            ...
            className="max-w-2xl mx-auto mt-10 bg-white p-2 rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col sm:flex-row gap-2 border border-gray-100"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-12 -mt-10 relative z-10">
          <div className="bg-white rounded-3xl shadow-lg border border-gray-100/60 p-8 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {trendingDestinations.map((dest) => (
              <Link
                ...
                className="group relative h-48 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
              >
                {/* Visual Cover Image */}
                <img 
                  src={dest.image} 
        ...
        <section className="py-10">
          <div className="bg-gradient-to-r from-indigo-900 via-blue-900 to-indigo-950 rounded-3xl text-white p-8 sm:p-12 text-left relative overflow-hidden shadow-xl flex flex-col md:flex-row justify-between items-center gap-8 border border-white/5">
            <div className="relative z-10 max-w-xl">
              <span className="bg-white/10 text-white text-[10px] font-semibold tracking-wider uppercase px-2.5 py-1 rounded-full border border-white/10">
                Partner Hosting
              </span>
              ...
              <p className="text-blue-100 mt-3 text-sm leading-relaxed">
                List your room or villa on LuxeKey and start welcoming global guests. Safe payouts, guest validation, and automated PDF invoice billing.
              </p>
            </div>
